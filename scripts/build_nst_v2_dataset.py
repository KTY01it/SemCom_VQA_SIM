...
def main():
    ...
    parser.add_argument("--out", default="results/nst/nst_v2_train.csv")
    ...
    for row in sg_rows:
        ...
        for rank_index, t in enumerate(selected):
            # Pseudo-label may use answer because this is offline supervision.
    ...
    if not rows:
        raise RuntimeError("No NST-v2 rows were produced.")
